...
{
    public class AccPedidoRepository : GenericRepository<AccPedido>, IAccPedidoRepository
    {
        private readonly SelfServiceContext context;
        private readonly IConfiguration configuration;

        public AccPedidoRepository(SelfServiceContext contex, IConfiguration configuration) : base(contex, configuration)
        {
            this.context = contex;
